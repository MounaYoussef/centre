...
class ProController extends AbstractController
{
     ...
     * @return JsonResponse
     * @Route("/search", name="pro_search", options={"expose" = true})
     */
    public function getCondidature(Request $request, ProRepository $proRepository){

        $text = $request->request->get('text');
        $search  = $proRepository->searchProductByName($text);
    ...
    /**
     * @Route("/{id}", name="pro_show", methods={"GET"})
     */
